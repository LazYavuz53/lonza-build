...
def get_pipeline(
    ...
    base_job_prefix="LonzaClinicalMarker",
    ...
    step_process = ProcessingStep(
        name="PreprocessLonzaClinicalMarkerData",
        step_args=step_args,
    )
    ...
    evaluation_report = PropertyFile(
        name="LonzaClinicalMarkerEvaluationReport",
        output_name="evaluation",
        path="evaluation.json",
    )
    step_eval = ProcessingStep(
        name="EvaluateLonzaClinicalMarkerModel",
        step_args=step_args,
    ...
    step_register = ModelStep(
        name="RegisterLonzaClinicalMarkerModel",
        step_args=step_args,
    )
